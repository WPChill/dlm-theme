...
get_header(); ?>
	...
	<section data-jarallax="" data-speed=".8" class="pt-10 pb-11 py-md-14 overlay overlay-black overlay-60 jarallax"
			 ...
			 data-jarallax-original-styles="background-image: url(assets/img/covers/cover-4.jpg);">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12 col-md-10 col-lg-8 text-center">
					...
					<p class="lead text-white-75 mb-0">
						We're here to help you better use Download Monitor. First, let's figure out if we have a
						solution in our documentation.
					</p>
				</div>
			</div> <!-- / .row -->
		</div> <!-- / .container -->
