		...
		<div class="row">
			<div class="col-12 col-md-4 benefits">
				...
				<div class="mb-3 text-benefits">
					<img class="homepage-benefits"
						 src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/Union.png">
				</div>
				<!-- Heading -->
			...
			<div class="col-12 col-md-4 benefits">
				...
				<div class="mb-3 text-benefits">
					<img class="homepage-benefits"
						 src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/scale.png">
				</div>
				<!-- Heading -->
			...
			<div class="col-12 col-md-4 benefits">
				...
				<div class="mb-3 text-benefits">
					<img class="homepage-benefits"
						 src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/headphones.png">
				</div>
				<!-- Heading -->
				...
				<div class="col-12 col-md-6 col-lg-4 d-flex">
					<div class="card mb-6 shadow-light-lg lift lift-lg">
						<a href="<?php echo get_permalink( $fproduct->get_id() ); ?>" class="bg-primary text-center">
							<!-- Image -->
							<?php echo get_the_post_thumbnail( $fproduct->get_id(), 'shop_catalog', array(
									'class' => 'card-img-top',
									'style' => 'width:auto'
							) ); ?>
						...
						$<?php echo $fproduct->get_price(); ?>
							...
							<!-- Read more -->
							<a class="text-uppercase ms-auto extensions-more"
							   href="<?php echo get_permalink( $fproduct->get_id() ); ?>">Read More</a>
						</div>
					</div>
				</div>
			<?php endforeach; ?>
	...
	<div class="container interface">
		<div class="row align-items-center justify-content-between">
			<div class="col-12 col-md-6 order-md-1">
				<div class="position-relative vw-md-50 float-end d-block">
					<div class="position-relative d-md-block aos-init aos-animate">
						<div class="card">
							<img class="interface-image img-fluid"
								 src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/interface.png">
						</div>
					</div>
				</div>
			</div>
			<div class="col-12 col-md-6 py-md-14 order-md-2 aos-init aos-animate">
				...
				<p class="interface-description"><strong>Download Monitor’s</strong> goal is to keep your files
					organized and provide means to monitor the amount of downloads a file has, along with an easy method
					of linking to those files using shortcodes.</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container intuitive">
		<div class="row align-items-center justify-content-between">
			<div class="col-12 col-md-6 order-md-2 aos-init aos-animate">
				<div class="card">
					<img class="card options-image-intuitive" style="width:100%"
						 src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/intuitive.png">
				</div>
			</div>
			<div class="col-12 col-md-6 order-md-1 aos-init aos-animate ">
				...
				<div class="intuitive-description">
					<p>The admin UI lists your downloads in an organized fashion listing useful file information and
						at-a-glance stats, whilst also providing search and filter functionality. Any user familiar with
						WordPress will find this instantly recognizable and easy to use.</p>
	...
	<div class="container quick-add">
		<div class="row row-quick-add align-items-center justify-content-between">
			<div class="col-12 col-md-6 aos-init aos-animate ">
				...
				<p class="quick-add-description">To make referencing existing downloads, or uploading new ones from
					posts, Download Monitor adds an ‘Insert Download’ button above your post editor to load the
					quick-add panel for convenience.</p>
			</div>
			<div class="col-12 col-md-6 aos-init aos-animate">
				<div class="card">
					<img class="options-image-quick-add" style="width:100%"
						 src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/quick-add.png">
				</div>
			</div>
		</div>
	</div>
...
<section class="pt-8">
	<div class="container versioning">
		<div class="row align-items-center justify-content-between">
			<div class="col-12 col-md-6 order-md-2 aos-init aos-animate">
				<div class="card">
					<img class="options-image-versioning" style="width:100%"
						 src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/versioning.png">
				</div>
			</div>
			<div class="col-12 col-md-6 order-md-1 aos-init aos-animate ">
				<h2 class="versioning-title">File Versioning</h2>
				<p class="versioning-description">As well as adding the main file, you can have other versions of files
					using the ‘File Versions’ interface. Your main version is clearly highlighted in blue and all
					versions can be re-ordered via drag and drop. Each file can also contain mirrors if you wish to
