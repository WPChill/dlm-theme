...
if ( sizeof( $licenses ) > 0 ) : ?>
	...
	<h2><?php _e( 'Legacy Licenses', 'license-wp' ); ?></h2>
		...
		<?php foreach ( $licenses as $license ) :
			...
			<tr>
				...
				<td class="lwp_licenses_download"><?php
					...
					echo '<a class="button lwp_button_convert_legacy" href="' . $license->get_renewal_url() . '">' . __( 'Convert License To Subscription', 'license-wp' ) . '</a>';
