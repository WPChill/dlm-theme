					...
					<div class="container pb-5">
						...
						<div class="row">
							<div class="col-12 col-md-4 ask">
								<!-- Heading -->
								<a href="/blog"
								   class="footer-titles"><?php esc_html_e( 'Forum.', 'wpchill-theme' ); ?></a>
								<!-- Text -->
								<p class="mb-6 mb-md-0 footer-description">
									For premium extension support simply reply to your purchase email. If you're looking
									for support for Download Monitor itself please use the community forum.
								</p>
							</div>
							...
							<div class="col-12 col-md-4 ask">
								<!-- Heading -->
								<a href="/contact/"
								   class="footer-titles"><?php esc_html_e( 'Contact.', 'wpchill-theme' ); ?></a>
								<!-- Text -->
								<p class="mb-6 mb-md-0 footer-description">
