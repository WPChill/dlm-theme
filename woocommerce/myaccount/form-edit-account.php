...
<div class="card card-bleed shadow-light-lg">
	<div class="card-header">
		<?php esc_html_e( 'Edit Account Details', 'woocommerce' ); ?>
	</div>
	<div class="card-body">
...
<div class="card card-bleed shadow-light-lg mt-6">
	<div class="card-header">
	...
	<div class="card-body">
			...
			<p>
				...
				<button type="submit" class="woocommerce-Button button account-details-button text-white" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
